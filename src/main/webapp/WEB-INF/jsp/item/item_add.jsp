...
<form id="form" action="${pageContext.request.contextPath}/item/add" method="post"
    ...
    <table class="table table-hover">
       ...
       <tr class="success">
        ...
        <tr class="danger">
            <td colspan="2">
                <input type="button" class="btn btn-danger" onclick="upload()" value="增加商品"/>
            </td>
        </tr>
    </table>
	</form>
...
<script>
    ...
    var fileSize =  document.getElementById('picFile').files[0].size; //获得文件大小；
        
        if (fileSize>5242880) {
            alert("您上传的图片过大"+fileSize)
        }else{
            $("#form").submit();
        }
    }
